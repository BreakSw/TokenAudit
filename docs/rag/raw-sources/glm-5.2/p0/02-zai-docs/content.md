...
title: "GLM-5.2 - Overview - Z.AI DEVELOPER DOCUMENT"
source_url: "https://docs.z.ai/guides/llm/glm-5.2"
final_url: "https://docs.z.ai/guides/llm/glm-5.2"
captured_at: "2026-08-24T14:15:06.664Z"
capture_provider: "firecrawl"
accepted_for_review: true
sha256: "3b4cd2953fa2d9855b8f02d17fd4936b0b66850c8c81af97054322102c4a2181"
---
> ## Documentation Index
>
...
[Skip to main content](https://docs.z.ai/guides/llm/glm-5.2#content-area)

## [​](https://docs.z.ai/guides/llm/glm-5.2\#overview)  Overview
...
## [​](https://docs.z.ai/guides/llm/glm-5.2\#capability)  Capability

[**Thinking Mode** \\
\\
Offering multiple thinking modes for different scenarios](https://docs.z.ai/guides/capabilities/thinking-mode)

[**Streaming Output** \\
\\
Support real-time streaming responses to enhance user interaction experience](https://docs.z.ai/guides/capabilities/streaming)

[**Function Call** \\
\\
Powerful tool invocation capabilities, enabling integration with various external toolsets](https://docs.z.ai/guides/capabilities/function-calling)

[**Context Caching** \\
\\
Intelligent caching mechanism to optimize performance in long conversations](https://docs.z.ai/guides/capabilities/cache)

[**Structured Output** \\
\\
Support for structured output formats like JSON, facilitating system integration](https://docs.z.ai/guides/capabilities/struct-output)

## MCP

Flexibly integrate external MCP tools and data sources to expand application scenarios

## [​](https://docs.z.ai/guides/llm/glm-5.2\#usage)  Usage
...
![Description](https://cdn.bigmodel.cn/markdown/1781632244480plan2.png?attname=plan2.png)Before its official release, GLM-5.2 was made available in advance to GLM Coding Plan users. Developers reported improvements mainly in the following areas:
...
## [​](https://docs.z.ai/guides/llm/glm-5.2\#resources)  Resources

- [API Documentation](https://docs.z.ai/api-reference/llm/chat-completion): Learn how to call the API.

## [​](https://docs.z.ai/guides/llm/glm-5.2\#quick-start)  Quick Start
