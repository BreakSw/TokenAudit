...
14 models
Quantizations
Use with llama.cppUse with LM StudioUse with JanUse with Ollama
27 models
Spaces using deepseek-ai/DeepSeek-V4-Pro100
Collection including deepseek-ai/DeepSeek-V4-Pro
8 items•Updated 9 days ago• 841
Paper for deepseek-ai/DeepSeek-V4-Pro
Paper • 2606.19348 •Published Apr 26• 38
Evaluation results
...
80.6
benchflow/skillsbench·Skillsbench V1 1 View evaluation results
\ source leaderboard
50.1 *
internlm/WildClawBenchleaderboard
+3 more
Expand 8 benchmarks
...
View evaluation results shared by the community
View evaluation results shared by the community
Source: SkillsBench v1.1 official leaderboard by benchflow
