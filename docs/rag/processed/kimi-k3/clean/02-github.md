...
3cb39df · 2 weeks agoAug 6, 2026
History
9 Commits
Open commit details
View commit history for this file. 9 Commits
Folders and files
Name Name Last commit message Last commit date assets assets initial commit last monthJul 27, 2026 LICENSE LICENSE initial commit last monthJul 27, 2026 README.md README.md Merge pull request #2 from aaryanporwal/docs/fix-modelscope-badge-color 2 weeks agoAug 6, 2026 k3_tech_report.pdf k3_tech_report.pdf update report pdf 2 weeks agoAug 6, 2026 View all files
...
Permalink: 1. Model Introduction
...
Permalink: 4. Native MXFP4 Quantization
...
Permalink: Coding Agent Framework
