...
The truth-seeking AI assistant.
Chat, search, reason, and create — all in one place.
Answers with what's happening now and speaks your language.
Try Grok Get SuperGrok
Chat
A truth-seeking assistant for everyday work — writing, research, and quick recaps.
Answers with reasoning you can follow step by step
Generates images, video, and code in the same thread
Natural voice conversations with low-latency back and forth
...
Real-time 𝕏 integration for breaking news and trends
Follow-up questions drill deeper into any topic
What do you want to know?
Search
Imagine
...
Text-to-image and text-to-video in one thread
Edit generated content with follow-up prompts
Up to 2K resolution and 15-second videos
What do you want to know?
Imagine
What do you want to know?
Fast
...
Open Grok Upgrade to SuperGrok
Building on Grok?
