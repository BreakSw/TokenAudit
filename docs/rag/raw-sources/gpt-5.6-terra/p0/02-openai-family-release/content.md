...
model: "GPT-5.6 Terra"
priority: "P0"
source_id: "02-openai-family-release"
...
captured_at: "2026-08-23T10:48:20.194Z"
capture_provider: "firecrawl"
accepted_for_review: true
sha256: "7dedee3be212cfc5e56f42994dfe4a3d896062ac80d854dd6bffbb6db87e1b13"
---
...
**_Update on July 30, 2026:_** _OpenAI reduced the price of GPT‑5.6 Luna by 80% and GPT‑5.6 Terra by 20%._ [_Learn more here_](https://openai.com/index/advancing-the-price-performance-frontier-with-gpt-5-6/) _._
...
GPT‑5.6 is our strongest cybersecurity model yet, achieving frontier performance with significantly fewer tokens. On **ExploitBench** [2](https://openai.com/index/gpt-5-6/#citation-bottom-2), which measures progress from reaching vulnerable code through arbitrary code execution, it scores 73.5% versus GPT‑5.5’s 47.9% at a comparable output-token budget. On **ExploitGym** [3](https://openai.com/index/gpt-5-6/#citation-bottom-3) **,** which asks agents to turn real-world vulnerabilities into working exploits, it almost doubles GPT‑5.5’s peak pass rate, from 15.1% to 24.9% under the two-hour cap; with six hours, it reaches 33.7%. On **SEC-Bench Pro,** which tests proof-of-concept generation on complex software, it scores 71.2% versus GPT‑5.5’s 45.8% at an improved latency. [1](https://openai.com/index/gpt-5-6/#citation-bottom-1)
...
Individuals can [verify their identity and request trusted access⁠(opens in a new window)](https://chatgpt.com/cyber?openaicom-did=17e316ed-056f-4a6c-960d-fb12c4f9a549&openaicom_referred=true), and organizations can [apply⁠](https://openai.com/form/enterprise-trusted-access-for-cyber/) for their teams. Individual members will need to enable [Advanced Account Security⁠(opens in a new window)](https://chatgpt.com/advanced-account-security?openaicom_referred=true&openaicom-did=17e316ed-056f-4a6c-960d-fb12c4f9a549&openaicom_referred=true) with hardware-backed passkeys by September 1 to retain access to our most cyber-capable frontier models; those who do not will return to default access. Users who do not already have hardware-backed passkeys can receive [preferred pricing⁠(opens in a new window)](https://chatgpt.com/yubikey?openaicom-did=17e316ed-056f-4a6c-960d-fb12c4f9a549&openaicom_referred=true) from our partner, Yubico. We are also taking additional steps to restrict access to high-risk entities and in high-risk jurisdictions.
...
Read more about our safeguards in the [updated GPT‑5.6 system card⁠(opens in a new window)](https://deploymentsafety.openai.com/gpt-5-6).
...
[7](https://openai.com/index/gpt-5-6/#citation-bottom-7), [8](https://openai.com/index/gpt-5-6/#citation-bottom-8)
...
Cyber capabilities are evaluated with reduced safeguards. Users can join [OpenAI Daybreak’s Trusted Access for Cyber program⁠](https://openai.com/index/daybreak-securing-the-world/) for increased access to defensive cyber capabilities. [Scroll to citation 1 reference](https://openai.com/index/gpt-5-6/#citation-top-1)

2. 2


All models are evaluated using the ExploitBench API harness with 5 seeds and reasoning continuity. [Scroll to citation 2 reference](https://openai.com/index/gpt-5-6/#citation-top-2)

3. 3


We ran ExploitGym on our alpha API, which outputs responses faster than our public API, and then rescaled to match our public API. When rescaling latencies to the speeds expected for our public API, this causes some estimated latencies to exceed the two- and six-hour time limits, despite being correctly obeyed in the evaluation run. To get faster speeds for time-sensitive work, we offer priority processing⁠ in the API and fast mode⁠ in Codex. [Scroll to citation 3 reference](https://openai.com/index/gpt-5-6/#citation-top-3)

4. 4


We estimate latency and API cost by looking at the production behavior of our models, and simulating offline. These estimates account for tool call details, sampled tokens, and input tokens. Real-world results may vary substantially, and depend on many factors not captured in our simulation. We simulate latency at fast API speeds, and cost at regular API pricing. [Scroll to citation 4 reference](https://openai.com/index/gpt-5-6/#citation-top-4)

5. 5


Models without reported output tokens, latency or cost are plotted as horizontal dotted lines. [Scroll to citation 5 reference](https://openai.com/index/gpt-5-6/#citation-top-5)

6. 6


For multi-agent, latency is derived from the root agent, while output token and API-cost totals include all tokens. Ultra is run with 4 agents. [Scroll to citation 6 reference](https://openai.com/index/gpt-5-6/#citation-top-6)

7. 7


We compute scores with the official scoring approach described in the HealthBench Professional paper, which is not comparable to results reported in Anthropic system cards. [Scroll to citation 7 reference](https://openai.com/index/gpt-5-6/#citation-top-7)

8. 8


ARC-AGI-3 for Opus 4.8 was run on high and not max reasoning effort, as this is the only published ARC-AGI-3 result. [Scroll to citation 8 reference](https://openai.com/index/gpt-5-6/#citation-top-8)
...
\\
ProductAug 18, 2026](https://openai.com/index/chatgpt-ads-expands-across-europe/)
...
\\
ProductAug 18, 2026](https://openai.com/index/chatgpt-for-teens/)
...
\\
ProductAug 13, 2026](https://openai.com/index/previewing-ultrafast/)
